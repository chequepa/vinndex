        ...
        <div className="relative z-20 max-w-5xl mx-auto px-6 pt-32 pb-24 text-center hero-text">
          ...
          <form action="/buscar" className="max-w-2xl mx-auto">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-2 text-snow/80 text-sm">
              ...
              <a href="/buscar?q=malbec" className="chip text-xs !py-1.5">
                Malbec
              </a>
              <a href="/buscar?q=catena" className="chip text-xs !py-1.5">
                Catena Zapata
              </a>
              <a href="/buscar?q=valle-de-uco" className="chip text-xs !py-1.5">
                Valle de Uco
              </a>
              <a href="/buscar?q=espumante" className="chip text-xs !py-1.5">
                Espumantes &lt; $15k
              </a>
            </div>
          </form>
